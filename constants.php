...
define('STUDENT_NAME', 'Bee Boossadee, Danyang Liu, Howard Hao');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '103517930, 103902523, 10411825');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Wednesday and Thursday 06:30PM');

// [ACTION REQUIRED] name of the object storage bucket that stores images
define('BUCKET_NAME', 'Assignment3_Bucket');
// [ACTION REQUIRED] region of the above bucket
define('REGION', 'us-ashburn-1');
// no need to update this const
define('S3_BASE_URL','
https://objectstorage.us-ashburn-1.oraclecloud.com/n/axkl7eiitqos/b/Assignment3_Bucket/o');
